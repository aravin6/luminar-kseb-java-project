	...
	public void service(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			pst = conn.prepareStatement(
					"SELECT complaint.consumer_id, comp_id,consumer_name, consumer_loc, comp_date, complaint, comp_status, consumer_phone FROM consumer_personal INNER JOIN complaint ON consumer_personal.consumer_id=complaint.consumer_id");
			rs = pst.executeQuery(
					"SELECT complaint.consumer_id, comp_id,consumer_name, consumer_loc, comp_date, complaint, comp_status, consumer_phone FROM consumer_personal INNER JOIN complaint ON consumer_personal.consumer_id=complaint.consumer_id");
			...
			out.println("<div class=\"complaintTable\">\r\n" + "<table class=\"comp\">\r\n" + "            <tr>\r\n"
					+ "<th>Consumer ID</th>\r\n" + "                <th>Complaint ID</th>\r\n" + "<th>Name</th>\r\n"
					+ "                <th>Location</th>\r\n" + "<th>Date</th>\r\n"
					+ "                <th>Complaint</th><th>Status</th><th>Phone</th></tr>");
			while (rs.next()) {
				out.println(" <tr>\r\n" + "                <td>" + rs.getInt(1) + "</td>\r\n" + "                <td>"
